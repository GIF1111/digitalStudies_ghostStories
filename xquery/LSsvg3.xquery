...
(: Full HTML with embedded SVG :)
<html>
  <head>
    <title>Ghost Story Timeline</title>
    <style>
  ...
  <body>
    <h1>Ghost Story Timeline</h1>
    <p>This visualization shows the distribution of ghost story publication years extracted from our XML data collection. Each blue dot represents a unique year found in the dataset.</p>
    ...
    <p>From {$min-year} to {$max-year}, we see how ghost story writing has evolved across time.</p>
  </body>
</html>
